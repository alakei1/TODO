...
class TestAPI:
    ...
    def test_create_parking(self, client, db_session):
        ...
        data = {"address": "New Parking 456", "count_places": 20, "opened": True}
    ...
    def test_enter_parking(self, client, db_session):
        ...
        data = {"client_id": client_obj.id, "parking_id": parking_obj.id}
        ...
        log = ClientParking.query.filter_by(
            client_id=client_obj.id, parking_id=parking_obj.id, time_out=None
        ).first()
    ...
    def test_exit_parking(self, client, db_session):
        ...
        parking_log = ClientParking(
            client_id=client_obj.id, parking_id=parking_obj.id, time_in=datetime.now()
        )
    ...
    def test_enter_parking_with_no_credit_card(self, client, db_session):
        ...
        client_obj = Client(
            name="NoCard", surname="User", credit_card=None, car_number="NOCARD"
        )
        parking_obj = Parking(
            address="Test Parking",
            opened=True,
